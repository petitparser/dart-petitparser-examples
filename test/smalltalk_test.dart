...
TypeMatcher<MessageNode> isMessageNode(
        Matcher receiver, String selector, SelectorType selectorType,
...
TypeMatcher<PragmaNode> isPragmaNode(String selector, SelectorType selectorType,
        {List<Matcher> arguments = const []}) =>
    isA<PragmaNode>()
        .having((node) => node.selector, 'selector', selector)
        .having((node) => node.selectorType, 'selectorType', selectorType)
...
TypeMatcher<MethodNode> isMethodNode(String selector, SelectorType selectorType,
        {List<String> arguments = const [],
...
exampleWithNumber: x
  ...
  ^ x < y''', grammar.start);
    ...
    verify(
        ...
        grammar.expression,
        parser.expression,
        isMessageNode(isLiteralNode(1), '+', SelectorType.binary,
    ...
    verify(
        ...
        grammar.method,
        parser.method,
        isMethodNode('negated', SelectorType.unary, statements: [
          isReturnNode(isMessageNode(isLiteralNode(0), '-', SelectorType.binary,
    ...
    verify(
        ...
        parser.sequence,
        isSequenceNode(
            temporaries: ['a'], statements: [isReturnNode(isLiteralNode(1))]));
    verify(
        'Sequence3',
        '| a | 1. ^ 2',
        grammar.sequence,
    ...
    verify(
        ...
        grammar.method,
        parser.method,
        isMethodNode('+', SelectorType.binary,
            arguments: ['a'], temporaries: ['b']));
    verify(
        'BinaryMethod3',
        '+ a b',
        grammar.method,
        parser.method,
        isMethodNode('+', SelectorType.binary,
            arguments: ['a'], statements: [isVariableNode('b')]));
    verify(
        'BinaryMethod4',
        '+ a | b | c',
        grammar.method,
    ...
    verify(
        ...
        grammar.pragma,
        parser.pragma,
        isPragmaNode('&', SelectorType.binary,
    ...
    verify(
        ...
        grammar.expression,
        parser.expression,
        isMessageNode(isLiteralNode(1), 'to:', SelectorType.keyword,
            arguments: [isLiteralNode(2)]));
    verify(
        'KeywordExpression2',
        '1 to: 2 by: 3',
        grammar.expression,
        parser.expression,
        isMessageNode(isLiteralNode(1), 'to:by:', SelectorType.keyword,
    ...
    verify(
        ...
        grammar.expression,
        parser.expression,
        isMessageNode(isLiteralNode(1), 'to:by:do:', SelectorType.keyword,
    ...
    verify(
        ...
        grammar.method,
        parser.method,
        isMethodNode('to:do:', SelectorType.keyword,
            arguments: ['a', 'b'], temporaries: ['c']));
    verify(
        'KeywordMethod3',
        'to: a do: b by: c d',
        grammar.method,
        parser.method,
        isMethodNode('to:do:by:', SelectorType.keyword,
            arguments: ['a', 'b', 'c'], statements: [isVariableNode('d')]));
    verify(
        'KeywordMethod4',
        'to: a do: b by: c | d | e',
        grammar.method,
    ...
    verify(
        ...
        grammar.pragma,
        parser.pragma,
        isPragmaNode('primitive:', SelectorType.keyword,
    ...
    verify(
        ...
        grammar.pragma,
        parser.pragma,
        isPragmaNode('primitive:error:', SelectorType.keyword,
    ...
    verify(
        ...
        parser.method,
        isMethodNode('abs', SelectorType.unary,
            temporaries: ['a'], statements: [isVariableNode('b')]));
    ...
    verify(
        ...
        grammar.method,
        parser.method,
        isMethodNode('method', SelectorType.unary,
    ...
    verify(
        ...
        grammar.method,
        parser.method,
        isMethodNode('method', SelectorType.unary, pragmas: [
    ...
    verify(
        ...
        parser.method,
        isMethodNode('method', SelectorType.unary, pragmas: [
          isPragmaNode('foo:', SelectorType.keyword,
