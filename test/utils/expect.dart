...
TypeMatcher isSuccess(String input,
        {dynamic value = anything, dynamic position}) =>
    isA<Parser>().having(
...
TypeMatcher isFailure(String input,
        {dynamic message = anything, dynamic position = anything}) =>
    isA<Parser>().having(
        (parser) => parser.parse(input),
        'parse',
        isA<Failure>()
