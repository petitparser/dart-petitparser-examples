import 'package:petitparser_examples/bibtex.dart' as bibtexExample;
import 'package:petitparser_examples/json.dart' as jsonExample;
import 'package:petitparser_examples/lisp.dart' as lispExample;
import 'package:petitparser_examples/math.dart' as mathExample;
import 'package:petitparser_examples/prolog.dart' as prologExample;
import 'package:petitparser_examples/uri.dart' as uriExample;

import 'util/runner.dart';

final bibtexParser = bibtexExample.BibTeXDefinition().build();
...
final lispParser = lispExample.LispParserDefinition().build();
...
final prologParser = prologExample.rulesParser;
const prologInput = 'foo(bar, zork) :- true.\n'
    'bok(X, Y) :- foo(X, Y), foo(Y, X).';

final mathParser = mathExample.parser;
const mathInput = '1 + 2 - (3 * 4 / sqrt(5 ^ pi)) - e';

final uriParser = uriExample.uri;
const uriInput =
